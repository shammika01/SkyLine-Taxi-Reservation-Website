    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div class="flex items-center justify-between pb-4 bg-white :bg-gray-900">
                    <div>
                        ...
                        <div id="dropdownAction"
                            ...
                            <ul class="py-1 text-sm text-gray-700 :text-gray-200"
                                ...
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100 :hover:bg-gray-600 :hover:text-white">Reward</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100 :hover:bg-gray-600 :hover:text-white">Promote</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100 :hover:bg-gray-600 :hover:text-white">Activate
                                        account</a>
                                </li>
                            </ul>
                            <div class="py-1">
                                <a href="#"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 :hover:bg-gray-600 :text-gray-200 :hover:text-white">Delete
                                    User</a>
                            </div>
                        </div>
                    </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 :text-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border-b :bg-gray-800 :border-gray-700 hover:bg-gray-50 :hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <a href="#" class="font-medium text-blue-600 :text-blue-500 hover:underline">Edit
                                    user</a>
                            </td>
                        </tr>
                        <tr class="bg-white border-b :bg-gray-800 :border-gray-700 hover:bg-gray-50 :hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <a href="#"
                                    class="font-medium text-blue-600 :text-blue-500 hover:underline">Edit user</a>
                            </td>
                        </tr>
                        <tr
