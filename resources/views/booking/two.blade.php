        ...
        <div class="mx-auto w-full max-w-[550px] bg-white p-12 rounded-lg">
            <form action="https://formbold.com/s/FORM_ID" method="POST">
                ...
                <div class="min-w-full">
                    <button
                        class="justify-items-start hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-center text-base font-semibold text-white outline-none">
                        Submit
                    </button>

                    <a href="{{ route('booking.one') }}"
                        class=" justify-items-end hover:shadow-form rounded-md bg-[#6A64F1] ms-52  py-3 px-8 text-center text-base font-semibold text-white outline-none">
                        Go back
                    </a>
                </div>
